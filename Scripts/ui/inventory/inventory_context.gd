...
@onready var inventory_node = get_node("/root/Playground/Inventory/Inv_UI")
@onready var chest_inventory_ui_node = get_node("/root/Playground/ChestInventory/ChestInventoryUi")

# Afficher le menu context
func show_menu(slot, is_chest_interface, from_chest):
	if is_chest_interface == true:
		var inventory_context_button_node = get_node("/root/Playground/ChestInventory/ChestInventoryUi/InventoryContext/HBoxContainer/Transfer")
...
func _on_transfer_pressed() -> void:
	var player_inventory_ui_node = get_node("/root/Playground/Inventory/Inv_UI")
